...
```bash
cd $base/annot
wget https://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/000/365/465/GCF_000365465.2_Ptep_2.0/GCF_000365465.2_Ptep_2.0_genomic.gtf.gz
gunzip GCF_000365465.2_Ptep_2.0_genomic.gtf.gz

grep "partial \"true\"" GCF_000365465.2_Ptep_2.0_genomic.gtf |  grep -o -P "transcript_id\ \"[^\"]+\"" | cut -f2 -d " " | tr -d \" | sort | uniq > partial_transcripts
grep "partial \"true\"" GCF_000365465.2_Ptep_2.0_genomic.gtf |  grep -o -P "gene_id\ \"[^\"]+\"" | cut -f2 -d " " | tr -d \" | sort | uniq > partial_genes
